...
def main():
    ...
    print(f"[FAST_SCAN_V8] source={summary['source']} bad_rows={len(rows)} unique_bad_keys={len(unique_rows)}")
    print(f"[FAST_SCAN_V8] unique_manifest={out / 'failed_unique_manifest.csv'}")
    return 0
